...
QROI = {}
QROI['x'] = dpc.calc_xarray_ROIs(Q, 'xROI', ['x'], ROI_descs['x'], reduce_fun)
QROI['y'] = dpc.calc_xarray_ROIs(Q, 'yROI', ['ya'], ROI_descs['y'], reduce_fun)
QROI['z'] = dpc.calc_xarray_ROIs(Q, 'zROI', ['z'], ROI_descs['z'], reduce_fun)

QROI2 = {}
QROI2['xy'] = dpc.calc_xarray_ROIs(QROI['y'], 'xROI', ['x'], ROI_descs['x'],
                                   reduce_fun, ROIset_dim_to_combine='yROI')
QROI2['xz'] = dpc.calc_xarray_ROIs(QROI['z'], 'xROI', ['x'], ROI_descs['x'],
                                   reduce_fun, ROIset_dim_to_combine='zROI')
QROI2['yx'] = dpc.calc_xarray_ROIs(QROI['x'], 'yROI', ['ya'], ROI_descs['y'],
                                   reduce_fun, ROIset_dim_to_combine='xROI')
QROI2['yz'] = dpc.calc_xarray_ROIs(QROI['z'], 'yROI', ['ya'], ROI_descs['y'],
                                   reduce_fun, ROIset_dim_to_combine='zROI')
QROI2['zx'] = dpc.calc_xarray_ROIs(QROI['x'], 'zROI', ['z'], ROI_descs['z'],
                                   reduce_fun, ROIset_dim_to_combine='xROI')
QROI2['zy'] = dpc.calc_xarray_ROIs(QROI['y'], 'zROI', ['z'], ROI_descs['z'],
                                   reduce_fun, ROIset_dim_to_combine='yROI')
...
for ROI_name, qROI2 in QROI2.items():
    print(f'\n====  ROI: {ROI_name}  ====')
    print(qROI2)
